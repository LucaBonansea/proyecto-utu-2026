...
- [ ] Mi sesión se mantiene activa hasta que cierro sesión o expira por inactividad.
...
**Puntos:** 8 **Prioridad:** Alta **Épica:** EP-02
...
**Puntos:** 5 **Prioridad:** Alta **Épica:** EP-02
...
**Puntos:** 3 **Prioridad:** Alta **Épica:** EP-02
...
- [ ] Ambos grupos de evidencias están claramente diferenciados (antes / después).
- [ ] Puedo ampliar cada imagen para verla en detalle.
...
- [ ] Debo completar materiales utilizados y observaciones antes de finalizar.
...
- [ ] El reclamo pasa a estado "Pendiente de aprobación" tras la finalización.
...
**Criterios de aceptación:**
- [ ] Las tareas rechazadas aparecen destacadas o priorizadas en mi listado de tareas.
- [ ] Puedo ver el motivo del rechazo indicado por la comuna.
- [ ] Puedo volver a registrar finalización (materiales, observaciones, evidencias) sobre la misma tarea.
- [ ] El reclamo vuelve a pasar a "Pendiente de aprobación" tras la corrección.
...
- [ ] Se puede identificar si un archivo corresponde a evidencia inicial o de resolución.
...
**Criterios de aceptación:**
- [ ] Puedo ver los reclamos en estado "Pendiente de aprobación".
- [ ] Puedo revisar la evidencia y observaciones cargadas por el equipo/proveedor.
- [ ] Puedo aprobar el trabajo, cerrando el reclamo como "Resuelto".
...
- [ ] Puedo editar los datos de un proveedor existente.
...
**Criterios de aceptación:**
- [ ] Puedo crear una nueva clasificación con nombre y área asociada.
- [ ] Puedo editar una clasificación existente.
- [ ] Puedo desactivar una clasificación sin eliminar el historial de reclamos que ya la usaron.
...
| HU6 | Como administrativo, quiero asignar una prioridad a un reclamo, para que se atienda con mayor urgencia cuando corresponda. | 3 | Alta | EP-02 |
...
| HU8a | Como ciudadano, quiero recibir notificaciones dentro de la app cuando cambia el estado de mi reclamo, para mantenerme informado sin tener que consultar manualmente. | 5 | Media | EP-03 |
...
| HU14 | Como equipo o proveedor, quiero consultar únicamente las tareas que tengo asignadas, para organizar mi trabajo diario. | 3 | Alta | EP-06 |
...
| HU16 | Como equipo o proveedor, quiero volver a trabajar sobre una tarea rechazada con prioridad, para corregir lo que no fue aprobado por la comuna. | 5 | Media | EP-06 |
...
| HU18 | Como equipo o proveedor, quiero registrar evidencia obligatoria del trabajo realizado, para poder marcar un reclamo como resuelto. | 3 | Alta | EP-07 / EP-08 |
